...
export const teacherNotifications: Notification[] = [
  ...
  { id: 'n4', kicker: 'Messages', title: 'The school office replied', body: 'Re: request for a second Further Maths period. The school office will confirm on Friday.', when: 'Yesterday', group: 'Earlier', to: '/teacher/msg-admin' },
