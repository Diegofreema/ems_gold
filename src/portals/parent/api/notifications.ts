...
export const parentNotifications: Notification[] = [
  ...
  { id: 'n4', kicker: 'Finance', title: 'Receipt RCT-8841 issued', body: '₦120,000 received by transfer. Keep this for your records.', when: '16 Nov', group: 'Earlier', to: '/parent/invoices' },
